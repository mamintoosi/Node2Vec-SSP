...
% Result metrics
\node[font=\sffamily\small, text=darkgray, align=left] at (-4.5, 2.2) {\textbf{Silhouette Score}};

\node[draw=green1, thick, rounded corners=2pt, fill=white, minimum width=4cm, minimum height=0.7cm, font=\sffamily\small] at (-4.5, 1.5) {\textbf{+35\% vs. PCA}};
